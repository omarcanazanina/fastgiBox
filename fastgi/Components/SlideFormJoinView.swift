...
struct SlideFormJoinView: View {
    ...
    var slide1:some View{
        VStack{
            ...
            Text("\(optionSlide)")
            Text("\(move)")
        }.frame(width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height-220, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
    }
    var slide2:some View{
        VStack{
            ...
            Text("\(optionSlide)")
            Text("\(move)")
        }.frame(width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height-220, alignment: .center)
    }
